...
public class Beta_AJS_Open_Links {
	...
	public static void main(String agrs[]) {
		...
		/*
		 * Thread.sleep(3000); System.out.println("Pushing code to GitHub test.");
		 * //driver.findElement(By.xpath(".//*[@id='top_line']/div/div[2]/div/span")).
		 * click();
		 * 
		 * driver.findElement(By.xpath(".//*[@id='cookie_policy']/div/div[3]/span")).
		 * click();
		 * 
		 * List<WebElement> linkElements = driver.findElements(By.tagName("a"));
		 * String[] linkTexts = new String[linkElements.size()]; int i = 0;
		 * 
		 * // extract the link texts of each link element for (WebElement e :
		 * linkElements) { linkTexts[i] = e.getText(); i++; }
		 * 
		 * // test each link for (String t : linkTexts) {
		 * driver.findElement(By.linkText(t)).click(); // if
		 * (driver.getTitle().equals(underConsTitle)) { // System.out.println("\"" + t +
		 * "\"" + " is under construction."); // } else { // System.out.println("\"" + t
		 * + "\"" + " is working."); // }
		 * 
